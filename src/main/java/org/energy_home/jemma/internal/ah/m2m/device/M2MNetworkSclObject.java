...
public class M2MNetworkSclObject implements M2MNetworkScl {
	...
	public ContentInstanceItemsList getSclContentInstanceItemsList(M2MContainerAddress containerFilterId, long instanceId) throws M2MServiceException {
		return networkSclManager.getSclContentInstanceItemsList(user, containerFilterId, instanceId);
	}

	public ContentInstanceItems getSclContentInstanceItems(M2MContainerAddress containerId, long startInstanceId, long endInstanceId) throws M2MServiceException {
		return networkSclManager.getSclContentInstanceItems(user, containerId, startInstanceId, endInstanceId);
	}

	public ContentInstanceItemsList getSclContentInstanceItemsList(M2MContainerAddress containerFilterId, long startInstanceId, long endInstanceId) throws M2MServiceException {
		return networkSclManager.getSclContentInstanceItemsList(user, containerFilterId, startInstanceId, endInstanceId);
	}

	public ContentInstance createSclContentInstance(M2MContainerAddress containerId, ContentInstance instance) throws M2MServiceException {
