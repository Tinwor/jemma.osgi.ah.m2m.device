 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://schemas.telecomitalia.it/m2m}Scl" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = { "scls" })
@XmlRootElement(name = "SclItems")
public class SclItems extends M2MXmlObject {

	@XmlElement(name = "Scl")
	protected List<Scl> scls;
	@XmlAttribute(name = "AddressedId")
	@XmlSchemaType(name = "anyURI")
	protected String addressedId;

	/**
	 * Gets the value of the scls property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the scls property.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Scl }
	 * 
	 * 
	 */
	public List<Scl> getScls() {
		if (scls == null) {
			scls = new ArrayList<Scl>();
		}
		return this.scls;
	}
