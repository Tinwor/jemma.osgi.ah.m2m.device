...
@XmlType(name = "", propOrder = { "id", "accessRightId", "creationTime", "lastModifiedTime", "expirationTime", "maxNrOfInstances", "maxByteSize", "maxInstanceAge" })
@XmlRootElement(name = "Container")
public class Container extends M2MXmlObject {
